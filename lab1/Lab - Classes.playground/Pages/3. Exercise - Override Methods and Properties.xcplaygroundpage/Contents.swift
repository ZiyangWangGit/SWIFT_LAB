...
defender.moveRight()
print("The current position is: \(defender.position)")

defender.fire()
print("The remaning fire power is: \(defender.remainingFirePower)")
...
defender.wasHit()
print("The current shield strength of defender is \(defender.shieldStrength) ,the current health of defender is \(defender.health)")
