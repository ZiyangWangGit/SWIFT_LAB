...
User.currentUser = User(userName: "Kevin", email: "zz@seneca.com", age: 27)
 ...
 */
let user2 = User(userName: "Steven", email: "ss@seneca.com", age: 27)
User.logIn(user: user2)
if let currentUser = User.currentUser {
    print("Current User Name: \(currentUser.userName)")
    print("Current User Email: \(currentUser.email)")
    print("Current User Age: \(currentUser.age)")
}
