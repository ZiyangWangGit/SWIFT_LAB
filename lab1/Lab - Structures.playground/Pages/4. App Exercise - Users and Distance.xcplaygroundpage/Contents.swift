...
var myInfo = User(name: "Ziyang Wang", age: 27, height: 175, weight: 54, activityLevel: 7)


print("Name: \(myInfo.name)")
print("Age: \(myInfo.age)")
print("Height: \(myInfo.height) cm")
print("Weight: \(myInfo.weight) kg")
print("Activity Level: \(myInfo.activityLevel)")
...
struct Distance {
    ...
    // Initializer for distance in meters
    init(meters: Double) {
        self.meters = meters
        self.feet = meters * 3.28084
    }
    
    // Initializer for distance in feet
    init(feet: Double) {
        self.feet = feet
...
var anotherone = Distance(feet: 2600)
print("Distance in meters: \(anotherone.meters)")
