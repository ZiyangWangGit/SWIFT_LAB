...
var somePlace = GPS()
print("Latitude of somePlace: \(somePlace.latitude)")
print("Longitude of somePlace: \(somePlace.longitude)")


//:  Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
somePlace.latitude = 51.514004
somePlace.longitude = 0.125226
print("Updated Latitude of somePlace: \(somePlace.latitude)")
print("Updated Longitude of somePlace: \(somePlace.longitude)")
...
print("Title of favoriteBook: \(favoriteBook.title)")
favoriteBook.title = "Harry Potter and the Sorcerer's Stone pages"
favoriteBook.author = "J.K.Rowling"
favoriteBook.pages = 320
favoriteBook.price = 88.88
