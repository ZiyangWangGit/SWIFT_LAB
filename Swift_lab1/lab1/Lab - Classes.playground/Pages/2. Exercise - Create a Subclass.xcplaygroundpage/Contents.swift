...
print("Thr current position is: \(destroyer.position)")
destroyer.moveRight()
print("Thr current position is: \(destroyer.position)")
...
//Because When we create falcon,it is an instance of the Spaceship class,it does not have access to properties or methods that are specific to subclasses of Spaceship, such as the Fighter class.
...
destroyer.fire()
print("Remaining fire power right now is: \(destroyer.remainingFirePower)")
destroyer.fire()
print("Remaining fire power right now is: \(destroyer.remainingFirePower)")
destroyer.fire()
print("Remaining fire power right now is: \(destroyer.remainingFirePower)")
